...
class Product:
    ...
    def return_product(self, material, season, color, category):
        m=material.get_item(self.material)

        string = ""
        string += '({} '.format(self.name)
        string += ' {}, '.format(category[self.category])
        string += ' {}, '.format(self.price)
        string += ' {}, '.format(color[self.color])
        string += ' {}, '.format(self.size)
        string += ' {}, '.format(season[self.season])
        string += ' {}) '.format(material.get_item(self.material))
        string += '\n'
...
class MyShop:
    ...
    def print_materials(self):
        return self.materials.print_items()

    def print_products(self):
        string = ""
        for k in self.products:
            string += self.products[k].return_product(self.materials, self.seasons, self.colors, self.categories)
        return string
